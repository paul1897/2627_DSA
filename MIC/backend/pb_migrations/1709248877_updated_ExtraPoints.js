...
migrate((db) => {
  ...
  const collection = dao.findCollectionByNameOrId("p942lmz8z26mz92")
  ...
  // remove
  collection.schema.removeField("ojguhl1i")

  // remove
  collection.schema.removeField("w0wl5cs7")

  // remove
  collection.schema.removeField("fop2tspv")

  // remove
  collection.schema.removeField("oijc1fhu")

  // remove
  collection.schema.removeField("tycq6xar")

  // remove
  collection.schema.removeField("uaefljd3")
